...
> **Terminology:** In this architecture, a **business task** is a bounded
> request or problem the workflow handles. The workflow handles that business
> task through [activities](../../taxonomy/terms.md#activity).
